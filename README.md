...
### Models
 ...
 - [FuXi: Ensemble-mean based forecast model] [A new ML model in the ECMWF web charts](https://www.ecmwf.int/en/about/media-centre/aifs-blog/2023/new-ml-model-ecmwf-web-charts)
